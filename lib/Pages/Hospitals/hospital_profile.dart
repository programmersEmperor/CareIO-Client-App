                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsets.only(
                                top: 15.sp, left: 10.sp, right: 10.sp),
                            child: AutoSizeText(
                              "Top requested doctors",
                              style: TextStyle(
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount:
                                          controller.dayTimeSlotList.length,
                                      itemBuilder: (_, index) =>
                                          DayTimeSLotItem(
                                        dayTimeSlot:
                                            controller.dayTimeSlotList[index],
                                        onTap: () =>
                                            controller.onTapDayTimeSlot(index),
                                      ),
                                    ),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: Obx(
                                    () => AnimatedSwitcher(
                                      ...
                                      child:
                                          controller.activeTimeSlotWidget.value,
                                    ),
                                  ),
                                ),
                                Padding(
